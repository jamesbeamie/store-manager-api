...
[![Build Status](https://travis-ci.org/jamesbeamie/store-manager-api.svg?branch=develop)](https://travis-ci.org/jamesbeamie/store-manager-api) [![Coverage Status](https://coveralls.io/repos/github/jamesbeamie/store-manager-api/badge.svg?branch=ch-adding-all-endpoints-161494653)](https://coveralls.io/github/jamesbeamie/store-manager-api?branch=ch-adding-all-endpoints-161494653)
## Store manager
